...
public class Post 
{
    ...
    public Post(String author, String eventType)
    {
        username = author;
        timestamp = System.currentTimeMillis();
        likes = 0;
    ...
    public String output()
    {
        ...
        output = output + timeString(timestamp) + "\n";
        if(likes > 0) {
            output = output +  "  -  " + likes + " people like this." + "\n";
        }
        else {
            output = output + "\n";
        }
        if(comments.isEmpty()) {
            output = output + "   No comments." + "\n";
        }
        else {
            output = output + "   " + comments.size() + " comment(s). Click here to view." + "\n";
        }
        return output;
    }
