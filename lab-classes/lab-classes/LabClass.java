...
public class LabClass
{
    ...
    {
        if(this.instructor.equals("unknown")) this.instructor = instructor.getName();
        else{
            System.out.println("This class already has an instructor.");
        }
    }
    /**
    ...
    {
        System.out.println("APCSA:" + timeAndDay);
