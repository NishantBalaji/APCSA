    ...
    private class ListenForButton implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e){
            ...
            if(e.getSource() == button1){
                ...
                if(freshmanNums.isSelected()) { 
                    textArea1.setText("");
                    textArea1.append((average(number1, number2, number3, number4, number5) * 1.15) + ""); 
                    textField6.setText("");
                    textField6.requestFocus();
                    freshmanNums.setSelected(true);
                } 
                
                else if(sophomoreNums.isSelected()) { 
                    textArea1.setText("");
                    textArea1.append((average(number1, number2, number3, number4, number5) * 1.10) + "");
                    textField6.setText("");
                    textField6.requestFocus();
                    freshmanNums.setSelected(true);
                } 
                else if(juniorNums.isSelected()) { 
                    textArea1.setText(""); 
                    textArea1.append((average(number1, number2, number3, number4, number5) * 1.05) + "");
                    textField6.setText("");
                    textField6.requestFocus();
                    freshmanNums.setSelected(true);
                } 
