...
public class LessonTwenty extends JFrame{
    ...
    public LessonTwenty(){
       ...
       // getScreenSize returns the size of th e screen
       ...
       // Define if the user can resize the frame (true by default)
        ...
        textField1.setText("First Name Here");

        // Change the tool tip for the text field
        textField1.setToolTipText("More of nothing");
        thePanel.add(textField1);
        
        JButton button1 = new JButton(new ImageIcon("submitbutton.jpg"));
        ...
        textArea1.setText("Background Inf\n");
